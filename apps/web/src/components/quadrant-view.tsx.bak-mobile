...
export default function QuadrantView({
  ...
  const Tile = ({
    ...
    return (
      <button
        onClick={() => open(kind)}
        style={cardStyle(f)}
        className="group flex h-full flex-col rounded-2xl p-5 min-h-[212px] text-left w-full transition-transform duration-200 hover:-translate-y-1"
      >
        <div className="flex items-start gap-3.5">
          ...
          <div className="flex-1 min-w-0">
            <p style={{ color: f.ink }} className="text-base font-semibold tracking-wide">{title}</p>
            <p style={{ color: f.dim }} className="text-sm">{subtitle}</p>
          </div>
          <div className="text-right shrink-0">
            <p style={{ color: f.ink }} className="text-4xl font-semibold leading-none tabular-nums">{count}</p>
            <p style={{ color: f.dim }} className="text-xs mt-1">{unit}</p>
          </div>
        </div>
  ...
  const row = 'flex items-center gap-4 rounded-xl border border-white/70 bg-white/70 px-4 py-3.5 mb-2.5';
    ...
    <div className="flex flex-1 flex-col min-h-0">
          ...
          <div className="flex items-center gap-5">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2.5">
                <p className="text-2xl font-semibold text-slate-900 truncate">{g.live.s.team.name}</p>
            ...
            <button
              ...
              className="shrink-0 rounded-xl bg-slate-900 px-7 py-3.5 text-base font-medium text-white hover:bg-slate-800"
            >Score now</button>
          </div>
        </div>
      ) : (
      ...
      <div className="flex flex-1 flex-col py-4 min-h-0">
        {panel === null ? (
          ...
          <div style={cardStyle(panelFinish)} className="flex flex-1 flex-col rounded-2xl p-6 min-h-[440px]">
